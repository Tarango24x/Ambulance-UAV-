...
public abstract class Quantity extends Numeric {
    ...
    /* renamed from: re */
    public RealNum mo10972re() {
        return number().mo10972re();
    }

    /* renamed from: im */
    public RealNum mo10971im() {
        return number().mo10971im();
    }
    ...
    public double doubleValue() {
        return unit().doubleValue() * mo10972re().doubleValue();
    }

    public double doubleImagValue() {
        return unit().doubleValue() * mo10971im().doubleValue();
    }
