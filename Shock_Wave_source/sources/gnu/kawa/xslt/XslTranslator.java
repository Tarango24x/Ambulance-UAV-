...
public class XslTranslator extends Lexer implements Consumer {
    ...
    public void endElement() {
        ...
        if (xslTag == "value-of") {
            ...
            String popMatchingAttribute = popMatchingAttribute("", ClientCookie.VERSION_ATTR, charAt + 1);
            ...
            String popMatchingAttribute2 = popMatchingAttribute("", LogFactory.PRIORITY_KEY, charAt + 1);
    ...
    public void parse(Compilation comp2) throws IOException {
        ...
        startDocument(mexp2);
        XMLParser.parse((LineBufferedReader) this.f220in, getMessages(), (Consumer) this);
        endDocument();
        comp2.pop(mexp2);
    }
}
