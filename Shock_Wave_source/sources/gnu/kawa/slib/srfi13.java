...
public class srfi13 extends ModuleBody {
    ...
    static {
        ...
        $Pcsubstring$Slshared = new ModuleMethod(srfi13, 201, Lit51, 12291);
        string$Mncopy = new ModuleMethod(srfi13, 202, Lit52, -4095);
        string$Mnmap = new ModuleMethod(srfi13, HttpStatus.SC_NON_AUTHORITATIVE_INFORMATION, Lit53, -4094);
        $Pcstring$Mnmap = new ModuleMethod(srfi13, HttpStatus.SC_NO_CONTENT, Lit54, 16388);
        string$Mnmap$Ex = new ModuleMethod(srfi13, HttpStatus.SC_RESET_CONTENT, Lit55, -4094);
        $Pcstring$Mnmap$Ex = new ModuleMethod(srfi13, HttpStatus.SC_PARTIAL_CONTENT, Lit56, 16388);
        string$Mnfold = new ModuleMethod(srfi13, HttpStatus.SC_MULTI_STATUS, Lit57, -4093);
        string$Mnfold$Mnright = new ModuleMethod(srfi13, YaVersion.YOUNG_ANDROID_VERSION, Lit58, -4093);
        ...
        string$Gr$Eq = new ModuleMethod(srfi13, Telnet.f235DO, Lit91, -4094);
        ...
        $Pcstring$Mncopy$Ex = new ModuleMethod(srfi13, 302, Lit126, 20485);
        string$Mncontains = new ModuleMethod(srfi13, 303, Lit127, -4094);
        string$Mncontains$Mnci = new ModuleMethod(srfi13, 304, Lit128, -4094);
        $Pckmp$Mnsearch = new ModuleMethod(srfi13, 305, Lit129, 28679);
        make$Mnkmp$Mnrestart$Mnvector = new ModuleMethod(srfi13, ErrorMessages.ERROR_TWITTER_SET_STATUS_FAILED, Lit130, -4095);
        kmp$Mnstep = new ModuleMethod(srfi13, 307, Lit131, 24582);
    ...
    public static Object stringParseStart$PlEnd(Object proc, Object s, Object args) {
        ...
        frame97.proc = proc;
        frame97.f124s = s;
        if (!strings.isString(frame97.f124s)) {
            misc.error$V("Non-string value", new Object[]{frame97.proc, frame97.f124s});
        }
        Object obj = frame97.f124s;
        try {
            frame97.slen = strings.stringLength((CharSequence) obj);
            if (C0621lists.isPair(args)) {
                Object apply1 = C0621lists.car.apply1(args);
                frame97.args = C0621lists.cdr.apply1(args);
                ...
                return misc.error$V("Illegal substring START spec", new Object[]{frame97.proc, frame97.start, frame97.f124s});
            }
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda2(Object end, Object args2) {
            ...
            return misc.error$V("Illegal substring START/END spec", new Object[]{this.proc, this.start, end, this.f124s});
        }
        ...
        public Object lambda1() {
            boolean x;
            if (C0621lists.isPair(this.args)) {
                Object end = C0621lists.car.apply1(this.args);
                Object args2 = C0621lists.cdr.apply1(this.args);
                ...
                if (!x2 ? !x2 : !(x = numbers.isExact(end)) ? !x : Scheme.numLEq.apply2(end, Integer.valueOf(this.slen)) == Boolean.FALSE) {
                    return misc.error$V("Illegal substring END spec", new Object[]{this.proc, end, this.f124s});
                }
    ...
    public class frame0 extends ModuleBody {
        ...
        public Object lambda3() {
            return srfi13.stringParseStart$PlEnd(this.proc, this.f125s, this.args);
        }

        /* access modifiers changed from: package-private */
        public Object lambda4(Object rest, Object start, Object end) {
            if (C0621lists.isPair(rest)) {
    ...
    public class frame2 extends ModuleBody {
        ...
        public Object lambda7() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mncopy, this.f137s, this.maybe$Mnstart$Plend);
        }

        /* access modifiers changed from: package-private */
        public CharSequence lambda8(Object start, Object end) {
            Object obj = this.f137s;
            try {
                try {
                    try {
    ...
    public class frame3 extends ModuleBody {
        ...
        public Object lambda9() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnmap, this.f148s, this.maybe$Mnstart$Plend);
        }

        /* access modifiers changed from: package-private */
        public Object lambda10(Object start, Object end) {
            return srfi13.$PcStringMap(this.proc, this.f148s, start, end);
        }
    }
    ...
    public class frame4 extends ModuleBody {
        ...
        public Object lambda11() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnmap$Ex, this.f159s, this.maybe$Mnstart$Plend);
        }

        /* access modifiers changed from: package-private */
        public Object lambda12(Object start, Object end) {
            return srfi13.$PcStringMap$Ex(this.proc, this.f159s, start, end);
        }
    }
    ...
    public class frame5 extends ModuleBody {
        ...
        public Object lambda13() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnfold, this.f170s, this.maybe$Mnstart$Plend);
        }
    ...
    public static Object stringFoldRight$V(Object kons, Object knil, Object s, Object[] argsArray) {
        ...
        try {
            ...
            e.setLine("/u2/home/jis/ai2-kawa/gnu/kawa/slib/srfi13.scm", 302, 3);
            throw e;
        }
    }
    ...
    public class frame6 extends ModuleBody {
        ...
        public Object lambda15() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnfold$Mnright, this.f179s, this.maybe$Mnstart$Plend);
        }
                                                    ...
                                                    try {
                                                        ...
                                                        try {
                                                            try {
                                                                ...
                                                                obj4 = C0621lists.cons(makeString, obj4);
                                                                i += i2;
                                                                i3 = 1;
                                                                i2 = chunk$Mnlen2;
                                        ...
                                        try {
                                            ...
                                            try {
                                                ...
                                                try {
                                                                ...
                                                                try {
                                                                    ...
                                                                    try {
                                                                        try {
                                                                            ...
                                                                            while (C0621lists.isPair(obj4)) {
                                                                                Object chunk = C0621lists.car.apply1(obj4);
                                                                                obj4 = C0621lists.cdr.apply1(obj4);
                                                                                try {
                                                                            ...
                                                                            try {
                                                                                ...
                                                                                e11.setLine("/u2/home/jis/ai2-kawa/gnu/kawa/slib/srfi13.scm", 416, 29);
                                                                                throw e11;
                                                                            }
                                                    ...
                                                    e18.setLine("/u2/home/jis/ai2-kawa/gnu/kawa/slib/srfi13.scm", 402, 38);
                                                    throw e18;
                                                }
                                            ...
                                            e20.setLine("/u2/home/jis/ai2-kawa/gnu/kawa/slib/srfi13.scm", HttpStatus.SC_BAD_REQUEST, 20);
                                            throw e20;
                                        }
    ...
    public static java.lang.Object stringUnfoldRight$V(java.lang.Object r29, java.lang.Object r30, java.lang.Object r31, java.lang.Object r32, java.lang.Object[] r33) {
        ...
        L_0x00ef:
            ...
            kawa.lib.strings.stringSet$Ex(r0, r1, r2)
            r0 = r22
            gnu.lists.Pair r13 = kawa.lib.C0621lists.cons(r0, r13)
            gnu.kawa.functions.AddOp r21 = gnu.kawa.functions.AddOp.$Pl
            r0 = r21
            r1 = r18
            r2 = r24
        ...
        L_0x0167:
            ...
            java.lang.Object r17 = r0.apply2(r1, r12)
        L_0x020c:
            boolean r21 = kawa.lib.C0621lists.isPair(r13)
            if (r21 == 0) goto L_0x0251
            gnu.expr.GenericProc r21 = kawa.lib.C0621lists.car
            r0 = r21
            java.lang.Object r9 = r0.apply1(r13)
            gnu.expr.GenericProc r21 = kawa.lib.C0621lists.cdr
            r0 = r21
    ...
    public class frame7 extends ModuleBody {
        ...
        public Object lambda19() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnfor$Mneach, this.f191s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame8 extends ModuleBody {
        ...
        public Object lambda21() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnfor$Mneach$Mnindex, this.f199s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame9 extends ModuleBody {
        ...
        public Object lambda23() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnevery, this.f204s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame10 extends ModuleBody {
        ...
        public Object lambda25() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnany, this.f126s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame11 extends ModuleBody {
        ...
        public Object lambda28() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Mnprefix$Mnlength, this.f127s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame12 extends ModuleBody {
        ...
        public Object lambda30() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnprefix$Mnlength, this.staticLink.f128s2, this.rest);
        }

        /* access modifiers changed from: package-private */
        public Object lambda31(Object start2, Object end2) {
            return srfi13.$PcStringPrefixLength(this.staticLink.f127s1, this.start1, this.end1, this.staticLink.f128s2, start2, end2);
        }
    }
    ...
    public class frame13 extends ModuleBody {
        ...
        public Object lambda32() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Mnsuffix$Mnlength, this.f129s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame14 extends ModuleBody {
        ...
        public Object lambda34() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnsuffix$Mnlength, this.staticLink.f130s2, this.rest);
        }

        /* access modifiers changed from: package-private */
        public Object lambda35(Object start2, Object end2) {
            return srfi13.$PcStringSuffixLength(this.staticLink.f129s1, this.start1, this.end1, this.staticLink.f130s2, start2, end2);
        }
    }
    ...
    public class frame15 extends ModuleBody {
        ...
        public Object lambda36() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Mnprefix$Mnlength$Mnci, this.f131s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame16 extends ModuleBody {
        ...
        public Object lambda38() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnprefix$Mnlength$Mnci, this.staticLink.f132s2, this.rest);
        }

        /* access modifiers changed from: package-private */
        public int lambda39(Object start2, Object end2) {
            Object obj = this.staticLink.f131s1;
            ...
            try {
                ...
                try {
                    try {
                        try {
                            return srfi13.$PcStringPrefixLengthCi(obj, intValue, ((Number) obj3).intValue(), this.staticLink.f132s2, ((Number) start2).intValue(), ((Number) end2).intValue());
                        } catch (ClassCastException e) {
    ...
    public class frame17 extends ModuleBody {
        ...
        public Object lambda40() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Mnsuffix$Mnlength$Mnci, this.f133s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame18 extends ModuleBody {
        ...
        public Object lambda42() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnsuffix$Mnlength$Mnci, this.staticLink.f134s2, this.rest);
        }

        /* access modifiers changed from: package-private */
        public int lambda43(Object start2, Object end2) {
            Object obj = this.staticLink.f133s1;
            Object obj2 = this.start1;
            try {
                int intValue = ((Number) obj2).intValue();
                Object obj3 = this.end1;
                try {
                    try {
                        try {
                            return srfi13.$PcStringSuffixLengthCi(obj, intValue, ((Number) obj3).intValue(), this.staticLink.f134s2, ((Number) start2).intValue(), ((Number) end2).intValue());
                        } catch (ClassCastException e) {
    ...
    public class frame19 extends ModuleBody {
        ...
        public Object lambda44() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Mnprefix$Qu, this.f135s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame20 extends ModuleBody {
        ...
        public Object lambda46() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnprefix$Qu, this.staticLink.f136s2, this.rest);
        }

        /* access modifiers changed from: package-private */
        public Object lambda47(Object start2, Object end2) {
            return srfi13.$PcStringPrefix$Qu(this.staticLink.f135s1, this.start1, this.end1, this.staticLink.f136s2, start2, end2);
        }
    }
    ...
    public class frame21 extends ModuleBody {
        ...
        public Object lambda48() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Mnsuffix$Qu, this.f138s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame22 extends ModuleBody {
        ...
        public Object lambda50() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnsuffix$Qu, this.staticLink.f139s2, this.rest);
        }

        /* access modifiers changed from: package-private */
        public Object lambda51(Object start2, Object end2) {
            return srfi13.$PcStringSuffix$Qu(this.staticLink.f138s1, this.start1, this.end1, this.staticLink.f139s2, start2, end2);
        }
    }
    ...
    public class frame23 extends ModuleBody {
        ...
        public Object lambda52() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Mnprefix$Mnci$Qu, this.f140s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame24 extends ModuleBody {
        ...
        public Object lambda54() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnprefix$Mnci$Qu, this.staticLink.f141s2, this.rest);
        }

        /* access modifiers changed from: package-private */
        public Object lambda55(Object start2, Object end2) {
            return srfi13.$PcStringPrefixCi$Qu(this.staticLink.f140s1, this.start1, this.end1, this.staticLink.f141s2, start2, end2);
        }
    }
    ...
    public class frame25 extends ModuleBody {
        ...
        public Object lambda56() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Mnsuffix$Mnci$Qu, this.f142s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame26 extends ModuleBody {
        ...
        public Object lambda58() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnsuffix$Mnci$Qu, this.staticLink.f143s2, this.rest);
        }

        /* access modifiers changed from: package-private */
        public Object lambda59(Object start2, Object end2) {
            return srfi13.$PcStringSuffixCi$Qu(this.staticLink.f142s1, this.start1, this.end1, this.staticLink.f143s2, start2, end2);
        }
    }
    ...
    public class frame27 extends ModuleBody {
        ...
        public Object lambda60() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Mncompare, this.f144s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame28 extends ModuleBody {
        ...
        public Object lambda62() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mncompare, this.staticLink.f145s2, this.rest);
        }

        /* access modifiers changed from: package-private */
        public Object lambda63(Object start2, Object end2) {
            return srfi13.$PcStringCompare(this.staticLink.f144s1, this.start1, this.end1, this.staticLink.f145s2, start2, end2, this.staticLink.proc$Ls, this.staticLink.proc$Eq, this.staticLink.proc$Gr);
        }
    }
    ...
    public class frame29 extends ModuleBody {
        ...
        public Object lambda64() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Mncompare$Mnci, this.f146s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame30 extends ModuleBody {
        ...
        public Object lambda66() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mncompare$Mnci, this.staticLink.f147s2, this.rest);
        }

        /* access modifiers changed from: package-private */
        public Object lambda67(Object start2, Object end2) {
            return srfi13.$PcStringCompareCi(this.staticLink.f146s1, this.start1, this.end1, this.staticLink.f147s2, start2, end2, this.staticLink.proc$Ls, this.staticLink.proc$Eq, this.staticLink.proc$Gr);
        }
    }
    ...
    public class frame31 extends ModuleBody {
        ...
        public Object lambda68() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Eq, this.f149s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame32 extends ModuleBody {
        ...
        public Object lambda70() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Eq, this.staticLink.f150s2, this.rest);
        }
        ...
        public Object lambda71(Object start2, Object end2) {
            ...
            try {
                ...
                boolean x2 = this.staticLink.f149s1 == this.staticLink.f150s2;
                if (x2) {
                ...
                return srfi13.$PcStringCompare(this.staticLink.f149s1, this.start1, this.end1, this.staticLink.f150s2, start2, end2, srfi13.lambda$Fn72, misc.values, srfi13.lambda$Fn73);
            } catch (ClassCastException e2) {
    ...
    public class frame33 extends ModuleBody {
        ...
        public Object lambda74() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Ls$Gr, this.f151s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame34 extends ModuleBody {
        ...
        public Object lambda76() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Ls$Gr, this.staticLink.f152s2, this.rest);
        }
        ...
        public Object lambda77(Object start2, Object end2) {
            ...
            try {
                ...
                boolean x2 = this.staticLink.f151s1 == this.staticLink.f152s2;
                if (x2) {
                    Object apply22 = Scheme.numEqu.apply2(this.start1, start2);
                    try {
                ...
                return srfi13.$PcStringCompare(this.staticLink.f151s1, this.start1, this.end1, this.staticLink.f152s2, start2, end2, misc.values, srfi13.lambda$Fn78, misc.values);
            } catch (ClassCastException e2) {
                throw new WrongType(e2, "x", -2, apply2);
            }
        }
    ...
    public class frame35 extends ModuleBody {
        ...
        public Object lambda79() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Ls, this.f153s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame36 extends ModuleBody {
        ...
        public Object lambda81() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Ls, this.staticLink.f154s2, this.rest);
        }

        /* access modifiers changed from: package-private */
        public Object lambda82(Object start2, Object end2) {
            boolean x = this.staticLink.f153s1 == this.staticLink.f154s2;
            if (!x ? x : Scheme.numEqu.apply2(this.start1, start2) != Boolean.FALSE) {
                return Scheme.numLss.apply2(this.end1, end2);
            }
            return srfi13.$PcStringCompare(this.staticLink.f153s1, this.start1, this.end1, this.staticLink.f154s2, start2, end2, misc.values, srfi13.lambda$Fn83, srfi13.lambda$Fn84);
        }
    ...
    public class frame37 extends ModuleBody {
        ...
        public Object lambda85() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Gr, this.f155s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame38 extends ModuleBody {
        ...
        public Object lambda87() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Gr, this.staticLink.f156s2, this.rest);
        }

        /* access modifiers changed from: package-private */
        public Object lambda88(Object start2, Object end2) {
            boolean x = this.staticLink.f155s1 == this.staticLink.f156s2;
            if (!x ? x : Scheme.numEqu.apply2(this.start1, start2) != Boolean.FALSE) {
                return Scheme.numGrt.apply2(this.end1, end2);
            }
            return srfi13.$PcStringCompare(this.staticLink.f155s1, this.start1, this.end1, this.staticLink.f156s2, start2, end2, srfi13.lambda$Fn89, srfi13.lambda$Fn90, misc.values);
        }
    ...
    public class frame39 extends ModuleBody {
        ...
        public Object lambda91() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Ls$Eq, this.f157s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame40 extends ModuleBody {
        ...
        public Object lambda93() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Ls$Eq, this.staticLink.f158s2, this.rest);
        }

        /* access modifiers changed from: package-private */
        public Object lambda94(Object start2, Object end2) {
            boolean x = this.staticLink.f157s1 == this.staticLink.f158s2;
            if (!x ? x : Scheme.numEqu.apply2(this.start1, start2) != Boolean.FALSE) {
                return Scheme.numLEq.apply2(this.end1, end2);
            }
            return srfi13.$PcStringCompare(this.staticLink.f157s1, this.start1, this.end1, this.staticLink.f158s2, start2, end2, misc.values, misc.values, srfi13.lambda$Fn95);
        }
    ...
    public class frame41 extends ModuleBody {
        ...
        public Object lambda96() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Gr$Eq, this.f160s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame42 extends ModuleBody {
        ...
        public Object lambda98() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Gr$Eq, this.staticLink.f161s2, this.rest);
        }

        /* access modifiers changed from: package-private */
        public Object lambda99(Object start2, Object end2) {
            boolean x = this.staticLink.f160s1 == this.staticLink.f161s2;
            if (!x ? x : Scheme.numEqu.apply2(this.start1, start2) != Boolean.FALSE) {
                return Scheme.numGEq.apply2(this.end1, end2);
            }
            return srfi13.$PcStringCompare(this.staticLink.f160s1, this.start1, this.end1, this.staticLink.f161s2, start2, end2, srfi13.lambda$Fn100, misc.values, misc.values);
        }
    ...
    public class frame43 extends ModuleBody {
        ...
        public Object lambda101() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Mnci$Eq, this.f162s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame44 extends ModuleBody {
        ...
        public Object lambda103() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnci$Eq, this.staticLink.f163s2, this.rest);
        }
        ...
        public Object lambda104(Object start2, Object end2) {
            ...
            try {
                ...
                boolean x2 = this.staticLink.f162s1 == this.staticLink.f163s2;
                if (x2) {
                    Object apply22 = Scheme.numEqu.apply2(this.start1, start2);
                    try {
                        x2 = ((Boolean) apply22).booleanValue();
                ...
                return srfi13.$PcStringCompareCi(this.staticLink.f162s1, this.start1, this.end1, this.staticLink.f163s2, start2, end2, srfi13.lambda$Fn105, misc.values, srfi13.lambda$Fn106);
            } catch (ClassCastException e2) {
                throw new WrongType(e2, "x", -2, apply2);
            }
        }
    ...
    public class frame45 extends ModuleBody {
        ...
        public Object lambda107() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Mnci$Ls$Gr, this.f164s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame46 extends ModuleBody {
        ...
        public Object lambda109() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnci$Ls$Gr, this.staticLink.f165s2, this.rest);
        }
        ...
        public Object lambda110(Object start2, Object end2) {
            ...
            try {
                ...
                boolean x2 = this.staticLink.f164s1 == this.staticLink.f165s2;
                if (x2) {
                    Object apply22 = Scheme.numEqu.apply2(this.start1, start2);
                    try {
                        if (apply22 == Boolean.FALSE) {
                ...
                return srfi13.$PcStringCompareCi(this.staticLink.f164s1, this.start1, this.end1, this.staticLink.f165s2, start2, end2, misc.values, srfi13.lambda$Fn111, misc.values);
            } catch (ClassCastException e2) {
                throw new WrongType(e2, "x", -2, apply2);
            }
        }
    ...
    public class frame47 extends ModuleBody {
        ...
        public Object lambda112() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Mnci$Ls, this.f166s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame48 extends ModuleBody {
        ...
        public Object lambda114() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnci$Ls, this.staticLink.f167s2, this.rest);
        }

        /* access modifiers changed from: package-private */
        public Object lambda115(Object start2, Object end2) {
            boolean x = this.staticLink.f166s1 == this.staticLink.f167s2;
            if (!x ? x : Scheme.numEqu.apply2(this.start1, start2) != Boolean.FALSE) {
                return Scheme.numLss.apply2(this.end1, end2);
            }
            return srfi13.$PcStringCompareCi(this.staticLink.f166s1, this.start1, this.end1, this.staticLink.f167s2, start2, end2, misc.values, srfi13.lambda$Fn116, srfi13.lambda$Fn117);
        }
    ...
    public class frame49 extends ModuleBody {
        ...
        public Object lambda118() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Mnci$Gr, this.f168s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame50 extends ModuleBody {
        ...
        public Object lambda120() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnci$Gr, this.staticLink.f169s2, this.rest);
        }

        /* access modifiers changed from: package-private */
        public Object lambda121(Object start2, Object end2) {
            boolean x = this.staticLink.f168s1 == this.staticLink.f169s2;
            if (!x ? x : Scheme.numEqu.apply2(this.start1, start2) != Boolean.FALSE) {
                return Scheme.numGrt.apply2(this.end1, end2);
            }
            return srfi13.$PcStringCompareCi(this.staticLink.f168s1, this.start1, this.end1, this.staticLink.f169s2, start2, end2, srfi13.lambda$Fn122, srfi13.lambda$Fn123, misc.values);
        }
    ...
    public class frame51 extends ModuleBody {
        ...
        public Object lambda124() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Mnci$Ls$Eq, this.f171s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame52 extends ModuleBody {
        ...
        public Object lambda126() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnci$Ls$Eq, this.staticLink.f172s2, this.rest);
        }
        ...
        public Object lambda127(Object start2, Object end2) {
            ...
            return srfi13.$PcStringCompareCi(this.staticLink.f171s1, this.start1, this.end1, this.staticLink.f172s2, start2, end2, misc.values, misc.values, srfi13.lambda$Fn128);
        }
    ...
    public class frame53 extends ModuleBody {
        ...
        public Object lambda129() {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Mnci$Gr$Eq, this.f173s1, this.maybe$Mnstarts$Plends);
        }
    ...
    public class frame54 extends ModuleBody {
        ...
        public Object lambda131() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnci$Gr$Eq, this.staticLink.f174s2, this.rest);
        }
        ...
        public Object lambda132(Object start2, Object end2) {
            ...
            return srfi13.$PcStringCompareCi(this.staticLink.f173s1, this.start1, this.end1, this.staticLink.f174s2, start2, end2, srfi13.lambda$Fn133, misc.values, misc.values);
        }
    ...
    public class frame56 extends ModuleBody {
        ...
        public Object lambda134() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnhash, this.f175s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        public Object lambda135(Object start, Object end) {
            return srfi13.$PcStringHash(this.f175s, characters.char$Mn$Grinteger, this.bound, start, end);
        }
    }
    ...
    public class frame57 extends ModuleBody {
        ...
        public Object lambda136() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnhash$Mnci, this.f176s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        public Object lambda137(Object start, Object end) {
            return srfi13.$PcStringHash(this.f176s, srfi13.lambda$Fn138, this.bound, start, end);
        }
    }
    ...
    public class frame58 extends ModuleBody {
        ...
        public Object lambda139() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnupcase, this.f177s, this.maybe$Mnstart$Plend);
        }

        /* access modifiers changed from: package-private */
        public Object lambda140(Object start, Object end) {
            return srfi13.$PcStringMap(unicode.char$Mnupcase, this.f177s, start, end);
        }
    }
    ...
    public class frame59 extends ModuleBody {
        ...
        public Object lambda141() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnupcase$Ex, this.f178s, this.maybe$Mnstart$Plend);
        }

        /* access modifiers changed from: package-private */
        public Object lambda142(Object start, Object end) {
            return srfi13.$PcStringMap$Ex(unicode.char$Mnupcase, this.f178s, start, end);
        }
    }
    ...
    public class frame60 extends ModuleBody {
        ...
        public Object lambda143() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mndowncase, this.f180s, this.maybe$Mnstart$Plend);
        }

        /* access modifiers changed from: package-private */
        public Object lambda144(Object start, Object end) {
            return srfi13.$PcStringMap(unicode.char$Mndowncase, this.f180s, start, end);
        }
    }
    ...
    public class frame61 extends ModuleBody {
        ...
        public Object lambda145() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mndowncase$Ex, this.f181s, this.maybe$Mnstart$Plend);
        }

        /* access modifiers changed from: package-private */
        public Object lambda146(Object start, Object end) {
            return srfi13.$PcStringMap$Ex(unicode.char$Mndowncase, this.f181s, start, end);
        }
    }
    ...
    public class frame62 extends ModuleBody {
        ...
        public Object lambda147() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mntitlecase$Ex, this.f182s, this.maybe$Mnstart$Plend);
        }

        /* access modifiers changed from: package-private */
        public Object lambda148(Object start, Object end) {
            return srfi13.$PcStringTitlecase$Ex(this.f182s, start, end);
        }
    }
    ...
    public class frame63 extends ModuleBody {
        ...
        public Object lambda149() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mntitlecase$Ex, this.f183s, this.maybe$Mnstart$Plend);
        }

        /* access modifiers changed from: package-private */
        public CharSequence lambda150(Object start, Object end) {
            Object obj = this.f183s;
            try {
                try {
                    try {
    ...
    public static Object stringTake(Object s, Object n) {
        ...
        frame642.f184n = n;
        try {
            Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), strings.string$Qu, frame642.f185s, string$Mntake);
            try {
                Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), frame642.lambda$Fn151, frame642.f184n, string$Mntake);
                Object obj = frame642.f185s;
                try {
                    CharSequence charSequence = (CharSequence) obj;
                    Object obj2 = frame642.f184n;
                    try {
    ...
    public class frame64 extends ModuleBody {
        ...
        public boolean lambda151(Object val) {
            boolean x = numbers.isInteger(this.f184n);
            if (!x) {
                return x;
            }
            boolean x2 = numbers.isExact(this.f184n);
            if (!x2) {
                return x2;
            }
            NumberCompare numberCompare = Scheme.numLEq;
            IntNum intNum = srfi13.Lit0;
            Object obj = this.f184n;
            Object obj2 = this.f185s;
            try {
    ...
    public static Object stringTakeRight(Object s, Object n) {
        ...
        try {
            ...
            try {
                ...
                try {
                    Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), frame652.lambda$Fn152, frame652.f186n, string$Mntake$Mnright);
                    try {
                        CharSequence charSequence = (CharSequence) s;
                        Object apply2 = AddOp.$Mn.apply2(Integer.valueOf(frame652.len), frame652.f186n);
                        try {
    ...
    public class frame65 extends ModuleBody {
        ...
        public boolean lambda152(Object val) {
            boolean x = numbers.isInteger(this.f186n);
            if (!x) {
                return x;
            }
            boolean x2 = numbers.isExact(this.f186n);
            return x2 ? ((Boolean) Scheme.numLEq.apply3(srfi13.Lit0, this.f186n, Integer.valueOf(this.len))).booleanValue() : x2;
        }
    ...
    public static Object stringDrop(CharSequence s, Object n) {
        ...
        try {
            Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), frame662.lambda$Fn153, frame662.f187n, string$Mndrop);
            Object obj = frame662.f187n;
            try {
    ...
    public class frame66 extends ModuleBody {
        ...
        public boolean lambda153(Object val) {
            boolean x = numbers.isInteger(this.f187n);
            if (!x) {
                return x;
            }
            boolean x2 = numbers.isExact(this.f187n);
            return x2 ? ((Boolean) Scheme.numLEq.apply3(srfi13.Lit0, this.f187n, Integer.valueOf(this.len))).booleanValue() : x2;
        }
    ...
    public static Object stringDropRight(CharSequence s, Object n) {
        ...
        try {
            Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), frame672.lambda$Fn154, frame672.f188n, string$Mndrop$Mnright);
            Object apply2 = AddOp.$Mn.apply2(Integer.valueOf(frame672.len), frame672.f188n);
            try {
    ...
    public class frame67 extends ModuleBody {
        ...
        public boolean lambda154(Object val) {
            boolean x = numbers.isInteger(this.f188n);
            if (!x) {
                return x;
            }
            boolean x2 = numbers.isExact(this.f188n);
            return x2 ? ((Boolean) Scheme.numLEq.apply3(srfi13.Lit0, this.f188n, Integer.valueOf(this.len))).booleanValue() : x2;
        }
    ...
    public class frame68 extends ModuleBody {
        ...
        public Object lambda155() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mntrim, this.f189s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        public Object lambda156(Object start, Object end) {
            try {
                Object temp = srfi13.stringSkip$V(this.f189s, srfi13.loc$criterion.get(), new Object[]{start, end});
                if (temp == Boolean.FALSE) {
                    return "";
                }
    ...
    public class frame69 extends ModuleBody {
        ...
        public Object lambda157() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mntrim$Mnright, this.f190s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        public Object lambda158(Object start, Object end) {
            try {
                Object temp = srfi13.stringSkipRight$V(this.f190s, srfi13.loc$criterion.get(), new Object[]{start, end});
                if (temp == Boolean.FALSE) {
                    return "";
                }
                Object obj = this.f190s;
                try {
                    CharSequence charSequence = (CharSequence) obj;
    ...
    public class frame70 extends ModuleBody {
        ...
        public Object lambda159() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mntrim$Mnboth, this.f192s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        public Object lambda160(Object start, Object end) {
            try {
                Object temp = srfi13.stringSkip$V(this.f192s, srfi13.loc$criterion.get(), new Object[]{start, end});
                if (temp == Boolean.FALSE) {
                    return "";
                }
                Object obj = this.f192s;
                try {
                    CharSequence charSequence = (CharSequence) obj;
                    try {
                        int intValue = ((Number) temp).intValue();
                        try {
                            Object apply2 = AddOp.$Pl.apply2(srfi13.Lit1, srfi13.stringSkipRight$V(this.f192s, srfi13.loc$criterion.get(), new Object[]{temp, end}));
                            try {
    ...
    public class frame71 extends ModuleBody {
        ...
        public Object lambda161() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnpad$Mnright, this.f194s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        public Object lambda162(Object start, Object end) {
            try {
                Scheme.applyToArgs.apply4(srfi13.loc$check$Mnarg.get(), srfi13.lambda$Fn163, this.f193n, srfi13.string$Mnpad$Mnright);
                if (Scheme.numLEq.apply2(this.f193n, AddOp.$Mn.apply2(end, start)) != Boolean.FALSE) {
                    Object obj = this.f194s;
                    try {
                        CharSequence charSequence = (CharSequence) obj;
                        try {
                            int intValue = ((Number) start).intValue();
                            Object apply2 = AddOp.$Pl.apply2(start, this.f193n);
                            try {
                                return srfi13.$PcSubstring$SlShared(charSequence, intValue, ((Number) apply2).intValue());
                            } catch (ClassCastException e) {
                                throw new WrongType(e, "%substring/shared", 2, apply2);
    ...
    public class frame72 extends ModuleBody {
        ...
        public Object lambda164() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnpad, this.f196s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        public Object lambda165(Object start, Object end) {
            try {
                Scheme.applyToArgs.apply4(srfi13.loc$check$Mnarg.get(), srfi13.lambda$Fn166, this.f195n, srfi13.string$Mnpad);
                Object len = AddOp.$Mn.apply2(end, start);
                if (Scheme.numLEq.apply2(this.f195n, len) != Boolean.FALSE) {
                    Object obj = this.f196s;
                    try {
                        CharSequence charSequence = (CharSequence) obj;
                        Object apply2 = AddOp.$Mn.apply2(end, this.f195n);
                        try {
                            try {
                    ...
                    Object obj2 = this.f195n;
                    try {
                        CharSequence ans = strings.makeString(((Number) obj2).intValue(), LangPrimType.charType);
                        Object apply22 = AddOp.$Mn.apply2(this.f195n, len);
                        try {
                            int intValue = ((Number) apply22).intValue();
                            Object obj3 = this.f196s;
                            try {
                                try {
                                    try {
    ...
    public class frame73 extends ModuleBody {
        ...
        public Object lambda167() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mndelete, this.f197s, this.maybe$Mnstart$Plend);
        }
        ...
        public CharSequence lambda168(Object start, Object end) {
            ...
            if (misc.isProcedure(this.criterion)) {
                ...
                try {
                    ...
                    Object ans$Mnlen = srfi13.stringFold$V(frame74.lambda$Fn169, srfi13.Lit0, this.f197s, new Object[]{start, end});
                ...
                try {
                    ...
                    Object len = srfi13.stringFold$V(frame74.lambda$Fn170, srfi13.Lit0, this.f197s, new Object[]{start, end});
                    try {
                        frame74.ans = strings.makeString(((Number) len).intValue());
                        srfi13.stringFold$V(frame74.lambda$Fn171, srfi13.Lit0, this.f197s, new Object[]{start, end});
                        return frame74.ans;
                    } catch (ClassCastException e4) {
    ...
    public class frame75 extends ModuleBody {
        ...
        public Object lambda172() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnfilter, this.f198s, this.maybe$Mnstart$Plend);
        }
        ...
        public CharSequence lambda173(Object start, Object end) {
            ...
            if (misc.isProcedure(this.criterion)) {
                ...
                try {
                    ...
                    Object ans$Mnlen = srfi13.stringFold$V(frame76.lambda$Fn174, srfi13.Lit0, this.f198s, new Object[]{start, end});
                    if (Scheme.numEqu.apply2(ans$Mnlen, slen) != Boolean.FALSE) {
                        return frame76.temp;
                    }
                    try {
                ...
                try {
                    ...
                    Object len = srfi13.stringFold$V(frame76.lambda$Fn175, srfi13.Lit0, this.f198s, new Object[]{start, end});
                    try {
                        frame76.ans = strings.makeString(((Number) len).intValue());
                        srfi13.stringFold$V(frame76.lambda$Fn176, srfi13.Lit0, this.f198s, new Object[]{start, end});
                        return frame76.ans;
                    } catch (ClassCastException e4) {
                        throw new WrongType(e4, "make-string", 1, len);
                    }
    ...
    public class frame81 extends ModuleBody {
        ...
        public Object lambda185() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mncount, this.f200s, this.maybe$Mnstart$Plend);
        }
    ...
    public static Object stringFill$Ex$V(Object s, Object obj, Object[] argsArray) {
        ...
        frame822.f201s = s;
        frame822.f286char = obj;
        frame822.maybe$Mnstart$Plend = LList.makeList(argsArray, 0);
        try {
            Scheme.applyToArgs.apply4(loc$check$Mnarg.get(), characters.char$Qu, frame822.f286char, string$Mnfill$Ex);
    ...
    public class frame82 extends ModuleBody {
        ...
        public Object lambda187() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnfill$Ex, this.f201s, this.maybe$Mnstart$Plend);
        }
        ...
        public Object lambda188(Object start, Object end) {
            Object i = AddOp.$Mn.apply2(end, srfi13.Lit1);
            while (Scheme.numLss.apply2(i, start) == Boolean.FALSE) {
                Object obj = this.f201s;
                try {
                    CharSeq charSeq = (CharSeq) obj;
                    try {
                        int intValue = ((Number) i).intValue();
                        Object obj2 = this.f286char;
                        try {
    ...
    public class frame88 extends ModuleBody {
        ...
        public Object lambda198(Object args) {
            return srfi13.stringParseStart$PlEnd(srfi13.string$Mnkmp$Mnpartial$Mnsearch, this.f202s, args);
        }
    ...
    public class frame89 extends ModuleBody {
        ...
        public Object lambda200() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnreverse, this.f203s, this.maybe$Mnstart$Plend);
        }
    ...
    public class frame90 extends ModuleBody {
        ...
        public Object lambda202() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnreverse$Ex, this.f205s, this.maybe$Mnstart$Plend);
        }
    ...
    public static CharSequence reverseList$To$String(Object clist) {
        try {
            int len = C0621lists.length((LList) clist);
            CharSequence s = strings.makeString(len);
            Object valueOf = Integer.valueOf(len - 1);
            while (C0621lists.isPair(clist)) {
                try {
                    CharSeq charSeq = (CharSeq) s;
                    try {
                        int intValue = ((Number) valueOf).intValue();
                        Object apply1 = C0621lists.car.apply1(clist);
                        try {
                            strings.stringSet$Ex(charSeq, intValue, ((Char) apply1).charValue());
                            valueOf = AddOp.$Mn.apply2(valueOf, Lit1);
                            clist = C0621lists.cdr.apply1(clist);
                        } catch (ClassCastException e) {
    ...
    public class frame91 extends ModuleBody {
        ...
        public Object lambda204() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mn$Grlist, this.f206s, this.maybe$Mnstart$Plend);
        }
        ...
        public Object lambda205(Object start, Object end) {
            ...
            while (Scheme.numLss.apply2(i, start) == Boolean.FALSE) {
                ...
                Object obj2 = this.f206s;
                try {
                    try {
                        obj = C0621lists.cons(Char.make(strings.stringRef((CharSequence) obj2, ((Number) i).intValue())), obj);
                        i = i2;
                    } catch (ClassCastException e) {
                        throw new WrongType(e, "string-ref", 2, i);
                    }
    ...
    public static java.lang.Object stringConcatenate$SlShared(java.lang.Object r14) {
        ...
        L_0x0005:
            boolean r9 = kawa.lib.C0621lists.isPair(r14)
            if (r9 == 0) goto L_0x003b
            gnu.expr.GenericProc r9 = kawa.lib.C0621lists.car
            java.lang.Object r7 = r9.apply1(r14)
            gnu.expr.GenericProc r9 = kawa.lib.C0621lists.cdr
    ...
    public static java.lang.CharSequence stringConcatenate(java.lang.Object r13) {
        /*
            ...
            r5 = r13
        L_0x0004:
            boolean r8 = kawa.lib.C0621lists.isPair(r5)
            if (r8 == 0) goto L_0x0029
            gnu.expr.GenericProc r8 = kawa.lib.C0621lists.cdr
            java.lang.Object r6 = r8.apply1(r5)
            gnu.kawa.functions.AddOp r9 = gnu.kawa.functions.AddOp.$Pl
            gnu.expr.GenericProc r8 = kawa.lib.C0621lists.car
        ...
        L_0x0037:
            boolean r8 = kawa.lib.C0621lists.isPair(r13)
                        ...
                        try {
                            try {
                                ...
                                try {
                                    ...
                                    while (true) {
                                        Object sum = obj6;
                                        if (C0621lists.isPair(obj7)) {
                                            AddOp addOp = AddOp.$Pl;
                                            Object apply1 = C0621lists.car.apply1(obj7);
                                            try {
                                                obj6 = addOp.apply2(sum, Integer.valueOf(strings.stringLength((CharSequence) apply1)));
                                                obj7 = C0621lists.cdr.apply1(obj7);
                                            } catch (ClassCastException e5) {
    ...
    public static java.lang.Object stringConcatenateReverse$SlShared$V(java.lang.Object r20, java.lang.Object[] r21) {
        ...
        L_0x008f:
            boolean r9 = kawa.lib.C0621lists.isPair(r20)
            ...
            try {
                try {
                    try {
                        ...
                        Object i = len;
                        while (C0621lists.isPair(string$Mnlist)) {
                            Object s = C0621lists.car.apply1(string$Mnlist);
                            Object lis = C0621lists.cdr.apply1(string$Mnlist);
                            try {
    ...
    public static Object stringReplace$V(Object s1, Object s2, Object start1, Object end1, Object[] argsArray) {
        ...
        checkSubstringSpec(string$Mnreplace, frame922.f207s1, frame922.start1, frame922.end1);
    ...
    public class frame92 extends ModuleBody {
        ...
        public Object lambda206() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnreplace, this.f208s2, this.maybe$Mnstart$Plend);
        }

        /* access modifiers changed from: package-private */
        public CharSequence lambda207(Object start2, Object end2) {
            Object obj = this.f207s1;
            try {
    ...
    public class frame93 extends ModuleBody {
        ...
        public Object lambda208() {
            try {
                return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mntokenize, this.f209s, srfi13.loc$rest.get());
            } catch (UnboundLocationException e) {
        ...
        public Object lambda209(Object start, Object end) {
            ...
            while (true) {
                ...
                try {
                    ...
                    if (x) {
                        try {
                            temp = srfi13.stringIndexRight$V(this.f209s, srfi13.loc$token$Mnchars.get(), new Object[]{start, i});
                        } catch (UnboundLocationException e) {
                    ...
                    try {
                        Object temp2 = srfi13.stringSkipRight$V(this.f209s, srfi13.loc$token$Mnchars.get(), new Object[]{start, temp});
                        if (temp2 != Boolean.FALSE) {
                            Object obj2 = this.f209s;
                            try {
                                CharSequence charSequence = (CharSequence) obj2;
                                Object apply22 = AddOp.$Pl.apply2(srfi13.Lit1, temp2);
                                try {
                                    try {
                                        obj = C0621lists.cons(strings.substring(charSequence, ((Number) apply22).intValue(), ((Number) tend).intValue()), obj);
                                        i = temp2;
                                    } catch (ClassCastException e2) {
                            ...
                            Object obj3 = this.f209s;
                            try {
                                try {
                                    try {
                                        return C0621lists.cons(strings.substring((CharSequence) obj3, ((Number) start).intValue(), ((Number) tend).intValue()), obj);
                                    } catch (ClassCastException e5) {
    ...
    public class frame94 extends ModuleBody {
            ...
            try {
                ...
                try {
                    if (numbers.isZero((Number) slen)) {
                        return misc.error$V("Cannot replicate empty (sub)string", new Object[]{srfi13.xsubstring, this.f210s, this.from, to, start, end});
                    } else if (Scheme.numEqu.apply2(srfi13.Lit1, slen) != Boolean.FALSE) {
                        try {
                            int intValue = ((Number) anslen).intValue();
                            Object obj = this.f210s;
                            try {
                                try {
                            ...
                            try {
                                if (doubleValue == numbers.floor(LangObjType.coerceRealNum(apply22)).doubleValue()) {
                                    ...
                                    try {
                                        ...
                                        srfi13.$PcMultispanRepcopy$Ex(ans, srfi13.Lit0, this.f210s, this.from, to, start, end);
                                        return ans;
                                    } catch (ClassCastException e7) {
        ...
        public Object lambda211() {
            if (C0621lists.isPair(this.maybe$Mnto$Plstart$Plend)) {
                return call_with_values.callWithValues(this.lambda$Fn212, this.lambda$Fn213);
            }
            try {
                Object apply4 = Scheme.applyToArgs.apply4(srfi13.loc$check$Mnarg.get(), strings.string$Qu, this.f210s, srfi13.xsubstring);
                try {
        ...
        public Object lambda212() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.xsubstring, this.f210s, C0621lists.cdr.apply1(this.maybe$Mnto$Plstart$Plend));
        }

        /* access modifiers changed from: package-private */
        public Object lambda213(Object start, Object end) {
            Object to = C0621lists.car.apply1(this.maybe$Mnto$Plstart$Plend);
            try {
    ...
    public class frame95 extends ModuleBody {
        ...
        public Object lambda221(Object sto, Object start, Object end) {
            ...
            try {
                ...
                if (!x) {
                    try {
                        if (numbers.isZero((Number) slen)) {
                            return misc.error$V("Cannot replicate empty (sub)string", new Object[]{srfi13.string$Mnxcopy$Ex, this.target, this.tstart, this.f211s, this.sfrom, sto, start, end});
                        } else if (Scheme.numEqu.apply2(srfi13.Lit1, slen) != Boolean.FALSE) {
                            Object obj = this.target;
                            Object obj2 = this.f211s;
                            try {
                                try {
                            ...
                            try {
                                ...
                                try {
                                    if (doubleValue != numbers.floor(LangObjType.coerceRealNum(apply22)).doubleValue()) {
                                        return srfi13.$PcMultispanRepcopy$Ex(this.target, this.tstart, this.f211s, this.sfrom, sto, start, end);
                                    }
        ...
        public Object lambda218() {
            return srfi13.stringParseFinalStart$PlEnd(srfi13.string$Mnxcopy$Ex, this.f211s, C0621lists.cdr.apply1(this.maybe$Mnsto$Plstart$Plend));
        }

        /* access modifiers changed from: package-private */
        public Object lambda219(Object start, Object end) {
            Object sto = C0621lists.car.apply1(this.maybe$Mnsto$Plstart$Plend);
            try {
            ...
            try {
                try {
                    try {
                        ...
                        if (C0621lists.isPair(strings)) {
                            try {
                                ...
                                if (x == Boolean.FALSE ? Scheme.isEqv.apply2(tmp, Lit16) != Boolean.FALSE : x != Boolean.FALSE) {
                                    error$V = C0621lists.cons(C0621lists.car.apply1(strings), lambda222buildit(C0621lists.cdr.apply1(strings), LList.Empty));
                                    ...
                                    try {
                                        error$V = C0621lists.cons(C0621lists.car.apply1(strings), lambda222buildit(C0621lists.cdr.apply1(strings), LList.list1(loc$delim.get())));
                                    } catch (UnboundLocationException e) {
                        ...
                        } else if (!C0621lists.isNull(strings)) {
    ...
    public class frame96 extends ModuleBody {
        ...
        public Object lambda223recur(Object lis) {
            if (!C0621lists.isPair(lis)) {
                return this.f287final;
            }
            try {
                return C0621lists.cons(srfi13.loc$delim.get(), C0621lists.cons(C0621lists.car.apply1(lis), lambda223recur(C0621lists.cdr.apply1(lis))));
            } catch (UnboundLocationException e) {
