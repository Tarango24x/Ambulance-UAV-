...
public class LangObjType extends ObjectType implements TypeValue {
    ...
    public static final LangObjType pathType = new LangObjType(ClientCookie.PATH_ATTR, "gnu.text.Path", 1);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0042, code lost:
        if (r6 == typeClass) goto L_0x004a;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x0048, code lost:
        if (r6 != typeClass.implementationType) goto L_0x004c;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x004e, code lost:
        if (r6 == typeType) goto L_?;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:28:0x0054, code lost:
        if (r6 != typeClass.implementationType) goto L_0x0008;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:34:0x0068, code lost:
        if ((r6 instanceof gnu.bytecode.PrimType) == false) goto L_0x0008;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x0072, code lost:
        switch(r6.getSignature().charAt(0)) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:39:?, code lost:
        return getImplementationType().compare(r6.getImplementationType());
     */
    ...
    public int compare(gnu.bytecode.Type r6) {
        ...
        L_0x0014:
            return r1
        L_0x0015:
            gnu.kawa.lispexpr.LangObjType r2 = typeType
            if (r6 == r2) goto L_0x0014
            gnu.kawa.lispexpr.LangObjType r2 = typeClassType
            if (r6 == r2) goto L_0x0014
            gnu.kawa.lispexpr.LangObjType r2 = typeType
            ...
            goto L_0x0014
        L_0x002a:
            gnu.kawa.lispexpr.LangObjType r3 = typeClass
            if (r6 == r3) goto L_0x003e
            gnu.kawa.lispexpr.LangObjType r3 = typeClassType
            if (r6 == r3) goto L_0x003e
            gnu.kawa.lispexpr.LangObjType r3 = typeClass
        ...
        L_0x004c:
            gnu.kawa.lispexpr.LangObjType r2 = typeType
            if (r6 == r2) goto L_0x0014
            gnu.kawa.lispexpr.LangObjType r2 = typeClass
            gnu.bytecode.ClassType r2 = r2.implementationType
            if (r6 != r2) goto L_0x0008
            goto L_0x0014
        L_0x0057:
