    ...
    public void process(HttpResponse response, HttpContext context) throws HttpException, IOException {
        if (response == null) {
            ...
            if (cookieSpec != null) {
                ...
                processCookies(response.headerIterator(C0869SM.SET_COOKIE), cookieSpec, cookieOrigin, cookieStore);
                if (cookieSpec.getVersion() > 0) {
                    processCookies(response.headerIterator(C0869SM.SET_COOKIE2), cookieSpec, cookieOrigin, cookieStore);
                }
            }
        }
    }
