...
public final class WeakHashtable extends Hashtable {
    ...
    public boolean containsKey(Object key) {
        return super.containsKey(new Referenced(key, (C08671) null));
    }
    ...
    public Set entrySet() {
        ...
        for (Map.Entry entry : referencedEntries) {
            ...
            if (key != null) {
                unreferencedEntries.add(new Entry(key, value, (C08671) null));
            }
        }
    ...
    public Object get(Object key) {
        return super.get(new Referenced(key, (C08671) null));
    }
    ...
    public Object put(Object key, Object value) {
        if (key == null) {
            ...
            return super.put(new Referenced(key, this.queue, (C08671) null), value);
        }
    }
    ...
    public Object remove(Object key) {
        ...
        return super.remove(new Referenced(key, (C08671) null));
    }
    ...
    private static final class Entry implements Map.Entry {
        ...
        Entry(Object x0, Object x1, C08671 x2) {
            this(x0, x1);
        }
    ...
    private static final class Referenced {
        ...
        Referenced(Object x0, ReferenceQueue x1, C08671 x2) {
            this(x0, x1);
        }

        Referenced(Object x0, C08671 x1) {
            this(x0);
        }
        ...
        private Referenced(Object key, ReferenceQueue queue) {
            this.reference = new WeakKey(key, queue, this, (C08671) null);
    ...
    private static final class WeakKey extends WeakReference {
        ...
        WeakKey(Object x0, ReferenceQueue x1, Referenced x2, C08671 x3) {
            this(x0, x1, x2);
        }
