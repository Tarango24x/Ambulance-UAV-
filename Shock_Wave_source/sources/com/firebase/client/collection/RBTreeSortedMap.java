...
public class RBTreeSortedMap<K, V> extends ImmutableSortedMap<K, V> {
    ...
    public ImmutableSortedMap<K, V> remove(K key) {
        return !containsKey(key) ? this : new RBTreeSortedMap<>(this.root.remove(key, this.comparator).copy(null, null, LLRBNode.Color.BLACK, (LLRBNode) null, (LLRBNode) null), this.comparator);
    }
            ...
            public Iterator<BooleanChunk> iterator() {
                return new Iterator<BooleanChunk>() {
                    ...
                    public BooleanChunk next() {
                        ...
                        if ((Base1_2.this.value & ((long) (1 << this.current))) != 0) {
                            z = false;
                        }
                        next.isOne = z;
