...
public class Base64 {
    ...
    public static java.lang.Object decodeToObject(java.lang.String r9, int r10, final java.lang.ClassLoader r11) throws java.io.IOException, java.lang.ClassNotFoundException {
        ...
        L_0x001e:
            return r3
        L_0x001f:
            com.firebase.client.utilities.Base64$1 r6 = new com.firebase.client.utilities.Base64$1     // Catch:{ IOException -> 0x0040, ClassNotFoundException -> 0x003d, all -> 0x003a }
        ...
        L_0x0040:
            ...
            goto L_0x0027
        */
        throw new UnsupportedOperationException("Method not decompiled: com.firebase.client.utilities.Base64.decodeToObject(java.lang.String, int, java.lang.ClassLoader):java.lang.Object");
    }
    ...
    public static class InputStream extends FilterInputStream {
        ...
        public int read() throws java.io.IOException {
            ...
            L_0x0022:
                ...
                int r5 = r11.options
                r4 = r1
                byte[] unused = com.firebase.client.utilities.Base64.encode3to4(r0, r1, r2, r3, r4, r5)
                r11.position = r1
                r11.numSigBytes = r10
            L_0x0030:
                int r3 = r11.position
            ...
            L_0x0058:
                ...
                byte[] r3 = r11.buffer
                int r4 = r11.options
                int r3 = com.firebase.client.utilities.Base64.decode4to3(r7, r1, r3, r1, r4)
                r11.numSigBytes = r3
                r11.position = r1
                goto L_0x0030
            L_0x0067:
    ...
    public static class OutputStream extends FilterOutputStream {
        ...
        public void write(int theByte) throws IOException {
            if (this.suspendEncoding) {
                ...
                if (this.position >= this.bufferLength) {
                    this.out.write(Base64.encode3to4(this.f264b4, this.buffer, this.bufferLength, this.options));
                    this.lineLength += 4;
                ...
                if (this.position >= this.bufferLength) {
                    this.out.write(this.f264b4, 0, Base64.decode4to3(this.buffer, 0, this.f264b4, 0, this.options));
                    this.position = 0;
                }
            } else if (this.decodabet[theByte & 127] != -5) {
        ...
        public void flushBase64() throws IOException {
            ...
            if (this.encode) {
                this.out.write(Base64.encode3to4(this.f264b4, this.buffer, this.position, this.options));
                this.position = 0;
                return;
            }
