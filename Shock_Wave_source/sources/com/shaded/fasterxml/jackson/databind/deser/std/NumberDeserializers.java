...
public class NumberDeserializers {
    ...
    public static StdDeserializer<?>[] all() {
        return new StdDeserializer[]{new BooleanDeserializer(Boolean.class, (Boolean) null), new ByteDeserializer(Byte.class, (Byte) null), new ShortDeserializer(Short.class, (Short) null), new CharacterDeserializer(Character.class, (Character) null), new IntegerDeserializer(Integer.class, (Integer) null), new LongDeserializer(Long.class, (Long) null), new FloatDeserializer(Float.class, (Float) null), new DoubleDeserializer(Double.class, (Double) null), new BooleanDeserializer(Boolean.TYPE, Boolean.FALSE), new ByteDeserializer(Byte.TYPE, (byte) 0), new ShortDeserializer(Short.TYPE, 0), new CharacterDeserializer(Character.TYPE, 0), new IntegerDeserializer(Integer.TYPE, 0), new LongDeserializer(Long.TYPE, 0L), new FloatDeserializer(Float.TYPE, Float.valueOf(0.0f)), new DoubleDeserializer(Double.TYPE, Double.valueOf(0.0d)), new NumberDeserializer(), new BigDecimalDeserializer(), new BigIntegerDeserializer()};
    }
    ...
    public static final class BooleanDeserializer extends PrimitiveOrWrapperDeserializer<Boolean> {
        ...
        private static final long serialVersionUID = 1;
        /* access modifiers changed from: private */
        public static final BooleanDeserializer wrapperInstance = new BooleanDeserializer(Boolean.TYPE, (Boolean) null);
    ...
    public static final class ShortDeserializer extends PrimitiveOrWrapperDeserializer<Short> {
        /* access modifiers changed from: private */
        public static final ShortDeserializer primitiveInstance = new ShortDeserializer(Short.class, 0);
        private static final long serialVersionUID = 1;
        /* access modifiers changed from: private */
        public static final ShortDeserializer wrapperInstance = new ShortDeserializer(Short.TYPE, (Short) null);
    ...
    public static final class CharacterDeserializer extends PrimitiveOrWrapperDeserializer<Character> {
        /* access modifiers changed from: private */
        public static final CharacterDeserializer primitiveInstance = new CharacterDeserializer(Character.class, 0);
        private static final long serialVersionUID = 1;
        /* access modifiers changed from: private */
        public static final CharacterDeserializer wrapperInstance = new CharacterDeserializer(Character.TYPE, (Character) null);
    ...
    public static final class IntegerDeserializer extends PrimitiveOrWrapperDeserializer<Integer> {
        /* access modifiers changed from: private */
        public static final IntegerDeserializer primitiveInstance = new IntegerDeserializer(Integer.class, 0);
        private static final long serialVersionUID = 1;
        /* access modifiers changed from: private */
        public static final IntegerDeserializer wrapperInstance = new IntegerDeserializer(Integer.TYPE, (Integer) null);
    ...
    public static final class LongDeserializer extends PrimitiveOrWrapperDeserializer<Long> {
        /* access modifiers changed from: private */
        public static final LongDeserializer primitiveInstance = new LongDeserializer(Long.class, 0L);
        private static final long serialVersionUID = 1;
        /* access modifiers changed from: private */
        public static final LongDeserializer wrapperInstance = new LongDeserializer(Long.TYPE, (Long) null);
    ...
    public static final class FloatDeserializer extends PrimitiveOrWrapperDeserializer<Float> {
        ...
        private static final long serialVersionUID = 1;
        /* access modifiers changed from: private */
        public static final FloatDeserializer wrapperInstance = new FloatDeserializer(Float.TYPE, (Float) null);
    ...
    public static final class DoubleDeserializer extends PrimitiveOrWrapperDeserializer<Double> {
        ...
        private static final long serialVersionUID = 1;
        /* access modifiers changed from: private */
        public static final DoubleDeserializer wrapperInstance = new DoubleDeserializer(Double.TYPE, (Double) null);
