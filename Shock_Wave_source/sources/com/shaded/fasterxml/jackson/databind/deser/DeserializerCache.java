    ...
    private JavaType modifyTypeByAnnotation(DeserializationContext deserializationContext, Annotated annotated, JavaType javaType) throws JsonMappingException {
        ...
        if (findDeserializationType != null) {
            try {
                ...
                throw new JsonMappingException("Failed to narrow type " + javaType + " with concrete-type annotation (value " + findDeserializationType.getName() + "), method '" + annotated.getName() + "': " + e.getMessage(), (JsonLocation) null, e);
            }
        } else {
            javaType2 = javaType;
        }
        ...
        if (findDeserializationKeyType == null) {
            ...
            try {
                ...
                throw new JsonMappingException("Failed to narrow key type " + javaType2 + " with key-type annotation (" + findDeserializationKeyType.getName() + "): " + e2.getMessage(), (JsonLocation) null, e2);
            }
        }
        ...
        if (findDeserializationContentType != null) {
            try {
                ...
                throw new JsonMappingException("Failed to narrow content type " + javaType3 + " with content-type annotation (" + findDeserializationContentType.getName() + "): " + e3.getMessage(), (JsonLocation) null, e3);
            }
        } else {
            javaType4 = javaType3;
        }
        if (javaType4.getContentType().getValueHandler() != null || (findContentDeserializer = annotationIntrospector.findContentDeserializer(annotated)) == null) {
            return javaType4;
        }
        ...
        if (deserializerInstance != null) {
            return javaType4.withContentValueHandler(deserializerInstance);
        }
        return javaType4;
    }
