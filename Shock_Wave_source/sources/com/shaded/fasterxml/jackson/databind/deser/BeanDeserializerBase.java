        ...
        if (this._valueInstantiator.canCreateFromObjectWith()) {
            ...
            for (SettableBeanProperty next : this._propertyBasedCreator.properties()) {
                if (next.hasValueTypeDeserializer()) {
                    ...
                    if (valueTypeDeserializer.getTypeInclusion() == JsonTypeInfo.C0806As.EXTERNAL_PROPERTY) {
                        if (builder == null) {
        ...
        while (it.hasNext()) {
            ...
            if (_resolveUnwrappedProperty != null) {
                ...
                if (_resolveInnerClassValuedProperty.hasValueTypeDeserializer()) {
                    ...
                    if (valueTypeDeserializer2.getTypeInclusion() == JsonTypeInfo.C0806As.EXTERNAL_PROPERTY) {
                        if (builder3 == null) {
