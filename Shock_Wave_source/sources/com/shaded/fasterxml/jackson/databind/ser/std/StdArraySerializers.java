...
public class StdArraySerializers {
    ...
    public static final class BooleanArraySerializer extends ArraySerializerBase<boolean[]> {
        ...
        public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
            ...
            createSchemaNode.put("items", (JsonNode) createSchemaNode(PropertyTypeConstants.PROPERTY_TYPE_BOOLEAN));
    ...
    public static final class ShortArraySerializer extends TypedPrimitiveArraySerializer<short[]> {
        ...
        public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
            ObjectNode createSchemaNode = createSchemaNode("array", true);
            createSchemaNode.put("items", (JsonNode) createSchemaNode(PropertyTypeConstants.PROPERTY_TYPE_INTEGER));
            return createSchemaNode;
        }
    ...
    public static final class CharArraySerializer extends StdSerializer<char[]> {
        ...
        public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
            ...
            createSchemaNode2.put("type", PropertyTypeConstants.PROPERTY_TYPE_STRING);
            createSchemaNode.put("items", (JsonNode) createSchemaNode2);
            return createSchemaNode;
        }
    ...
    public static final class LongArraySerializer extends TypedPrimitiveArraySerializer<long[]> {
        ...
        public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
            ObjectNode createSchemaNode = createSchemaNode("array", true);
            createSchemaNode.put("items", (JsonNode) createSchemaNode("number", true));
            return createSchemaNode;
        }
    ...
    public static final class FloatArraySerializer extends TypedPrimitiveArraySerializer<float[]> {
        ...
        public JsonNode getSchema(SerializerProvider serializerProvider, Type type) {
            ObjectNode createSchemaNode = createSchemaNode("array", true);
            createSchemaNode.put("items", (JsonNode) createSchemaNode("number"));
            return createSchemaNode;
        }
