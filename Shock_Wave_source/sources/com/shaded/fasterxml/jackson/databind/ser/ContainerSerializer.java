...
public abstract class ContainerSerializer<T> extends StdSerializer<T> {
    ...
    public boolean hasContentTypeAnnotation(SerializerProvider serializerProvider, BeanProperty beanProperty) {
        ...
        if (beanProperty == null || (annotationIntrospector = serializerProvider.getAnnotationIntrospector()) == null || annotationIntrospector.findSerializationContentType(beanProperty.getMember(), beanProperty.getType()) == null) {
            return false;
        }
        return true;
    }
