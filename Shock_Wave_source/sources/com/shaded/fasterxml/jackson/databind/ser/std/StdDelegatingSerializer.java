...
public class StdDelegatingSerializer extends StdSerializer<Object> implements ContextualSerializer, ResolvableSerializer, JsonFormatVisitable, SchemaAware {
    ...
    public JsonSerializer<?> createContextual(SerializerProvider serializerProvider, BeanProperty beanProperty) throws JsonMappingException {
        ...
        } else if (!(this._delegateSerializer instanceof ContextualSerializer) || (createContextual = ((ContextualSerializer) this._delegateSerializer).createContextual(serializerProvider, beanProperty)) == this._delegateSerializer) {
            return this;
        } else {
