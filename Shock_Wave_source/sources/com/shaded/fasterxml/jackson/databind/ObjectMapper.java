...
public class ObjectMapper extends ObjectCodec implements Versioned, Serializable {
    ...
    public static class DefaultTypeResolverBuilder extends StdTypeResolverBuilder implements Serializable {
        ...
        public boolean useForType(com.shaded.fasterxml.jackson.databind.JavaType r5) {
            /*
                ...
                r1 = 1
                r0 = 0
                int[] r2 = com.shaded.fasterxml.jackson.databind.ObjectMapper.C08162.f271x3ef634e7
                com.shaded.fasterxml.jackson.databind.ObjectMapper$DefaultTyping r3 = r4._appliesFor
                int r3 = r3.ordinal()
                r2 = r2[r3]
                switch(r2) {
            ...
            L_0x000f:
                java.lang.Class r2 = r5.getRawClass()
            ...
            L_0x0018:
                ...
                com.shaded.fasterxml.jackson.databind.JavaType r5 = r5.getContentType()
                goto L_0x0018
            L_0x0023:
                java.lang.Class r2 = r5.getRawClass()
                java.lang.Class<java.lang.Object> r3 = java.lang.Object.class
    ...
    public ObjectMapper enableDefaultTyping(DefaultTyping defaultTyping) {
        return enableDefaultTyping(defaultTyping, JsonTypeInfo.C0806As.WRAPPER_ARRAY);
    }

    public ObjectMapper enableDefaultTyping(DefaultTyping defaultTyping, JsonTypeInfo.C0806As as) {
        return setDefaultTyping(new DefaultTypeResolverBuilder(defaultTyping).init(JsonTypeInfo.C0807Id.CLASS, (TypeIdResolver) null).inclusion(as));
    }

    public ObjectMapper enableDefaultTypingAsProperty(DefaultTyping defaultTyping, String str) {
        return setDefaultTyping(new DefaultTypeResolverBuilder(defaultTyping).init(JsonTypeInfo.C0807Id.CLASS, (TypeIdResolver) null).inclusion(JsonTypeInfo.C0806As.PROPERTY).typeProperty(str));
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final void _configAndWriteCloseable(com.shaded.fasterxml.jackson.core.JsonGenerator r6, java.lang.Object r7, com.shaded.fasterxml.jackson.databind.SerializationConfig r8) throws java.io.IOException, com.shaded.fasterxml.jackson.core.JsonGenerationException, com.shaded.fasterxml.jackson.databind.JsonMappingException {
        /*
            r5 = this;
            r2 = 0
            r0 = r7
            java.io.Closeable r0 = (java.io.Closeable) r0
            com.shaded.fasterxml.jackson.databind.ser.DefaultSerializerProvider r1 = r5._serializerProvider(r8)     // Catch:{ all -> 0x001e }
            r1.serializeValue(r6, r7)     // Catch:{ all -> 0x001e }
            r1 = 0
        ...
        L_0x003b:
            ...
            goto L_0x0023
        */
        throw new UnsupportedOperationException("Method not decompiled: com.shaded.fasterxml.jackson.databind.ObjectMapper._configAndWriteCloseable(com.shaded.fasterxml.jackson.core.JsonGenerator, java.lang.Object, com.shaded.fasterxml.jackson.databind.SerializationConfig):void");
    }

    /* JADX WARNING: Removed duplicated region for block: B:14:0x0025 A[SYNTHETIC, Splitter:B:14:0x0025] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final void _writeCloseableValue(com.shaded.fasterxml.jackson.core.JsonGenerator r4, java.lang.Object r5, com.shaded.fasterxml.jackson.databind.SerializationConfig r6) throws java.io.IOException, com.shaded.fasterxml.jackson.core.JsonGenerationException, com.shaded.fasterxml.jackson.databind.JsonMappingException {
        /*
            r3 = this;
            r0 = r5
            java.io.Closeable r0 = (java.io.Closeable) r0
            com.shaded.fasterxml.jackson.databind.ser.DefaultSerializerProvider r1 = r3._serializerProvider(r6)     // Catch:{ all -> 0x001f }
            r1.serializeValue(r4, r5)     // Catch:{ all -> 0x001f }
            com.shaded.fasterxml.jackson.databind.SerializationFeature r1 = com.shaded.fasterxml.jackson.databind.SerializationFeature.FLUSH_AFTER_WRITE_VALUE     // Catch:{ all -> 0x001f }
        ...
        L_0x002d:
            ...
            goto L_0x0023
        */
        throw new UnsupportedOperationException("Method not decompiled: com.shaded.fasterxml.jackson.databind.ObjectMapper._writeCloseableValue(com.shaded.fasterxml.jackson.core.JsonGenerator, java.lang.Object, com.shaded.fasterxml.jackson.databind.SerializationConfig):void");
    }
