...
public final class TypeFactory implements Serializable {
    ...
    public JavaType constructSimpleType(Class<?> cls, JavaType[] javaTypeArr) {
        ...
        return new SimpleType(cls, strArr, javaTypeArr, (Object) null, (Object) null, false);
    }
    ...
    public JavaType _fromClass(Class<?> cls, TypeBindings typeBindings) {
        ...
        if (cls.isArray()) {
            simpleType = ArrayType.construct(_constructType(cls.getComponentType(), (TypeBindings) null), (Object) null, (Object) null);
        } else if (cls.isEnum()) {
    ...
    public JavaType _fromParameterizedClass(Class<?> cls, List<JavaType> list) {
        if (cls.isArray()) {
            return ArrayType.construct(_constructType(cls.getComponentType(), (TypeBindings) null), (Object) null, (Object) null);
        }
        if (cls.isEnum()) {
            return new SimpleType(cls);
        }
