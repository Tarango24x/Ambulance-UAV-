...
public class UTF32Reader extends BaseReader {
    ...
    public int read(char[] cArr, int i, int i2) throws IOException {
        ...
        while (true) {
            ...
            int i7 = this._ptr;
            if (this._bigEndian) {
                b = (this._buffer[i7 + 3] & Ev3Constants.Opcode.TST) | (this._buffer[i7] << 24) | ((this._buffer[i7 + 1] & Ev3Constants.Opcode.TST) << 16) | ((this._buffer[i7 + 2] & Ev3Constants.Opcode.TST) << 8);
            } else {
                b = (this._buffer[i7 + 3] << 24) | (this._buffer[i7] & Ev3Constants.Opcode.TST) | ((this._buffer[i7 + 1] & Ev3Constants.Opcode.TST) << 8) | ((this._buffer[i7 + 2] & Ev3Constants.Opcode.TST) << 16);
            }
            this._ptr += 4;
            if (b > 65535) {
                if (b > 1114111) {
                ...
                b = (i8 & Ev3Constants.Opcode.TST) | 56320;
                if (i4 >= i5) {
