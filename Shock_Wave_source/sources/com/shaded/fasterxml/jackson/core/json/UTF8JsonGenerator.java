...
import com.shaded.fasterxml.jackson.core.p004io.CharacterEscapes;
...
public class UTF8JsonGenerator extends JsonGeneratorImpl {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0028, code lost:
        ...
        r3 = r6._outputTail;
        r6._outputTail = r3 + 1;
        r2[r3] = (byte) ((r0 >> 6) | com.google.appinventor.components.runtime.util.FullScreenVideoUtil.FULLSCREEN_VIDEO_ACTION_PAUSE);
        r2 = r6._outputBuffer;
        r3 = r6._outputTail;
        r6._outputTail = r3 + 1;
        r2[r3] = (byte) ((r0 & '?') | 128);
    ...
    public final void writeRaw(char[] r7, int r8, int r9) throws java.io.IOException, com.shaded.fasterxml.jackson.core.JsonGenerationException {
        /*
            r6 = this;
            int r0 = r9 + r9
            int r0 = r0 + r9
    ...
    public void writeRaw(char c) throws IOException, JsonGenerationException {
        ...
        if (c <= 127) {
            ...
            int i2 = this._outputTail;
            this._outputTail = i2 + 1;
            bArr[i2] = (byte) ((c >> 6) | FullScreenVideoUtil.FULLSCREEN_VIDEO_ACTION_PAUSE);
            int i3 = this._outputTail;
            this._outputTail = i3 + 1;
            bArr[i3] = (byte) ((c & '?') | 128);
        } else {
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private final void _writeSegmentedRaw(char[] r7, int r8, int r9) throws java.io.IOException, com.shaded.fasterxml.jackson.core.JsonGenerationException {
        /*
            r6 = this;
            int r1 = r6._outputEnd
            byte[] r2 = r6._outputBuffer
    ...
    private final void _writeStringSegment2(char[] cArr, int i, int i2) throws IOException, JsonGenerationException {
        ...
        while (i < i2) {
            ...
            if (c > 127) {
                if (c <= 2047) {
                    int i5 = i3 + 1;
                    bArr[i3] = (byte) ((c >> 6) | FullScreenVideoUtil.FULLSCREEN_VIDEO_ACTION_PAUSE);
                    i3 = i5 + 1;
                    bArr[i5] = (byte) ((c & '?') | 128);
                } else {
    ...
    public void _writeBinary(Base64Variant base64Variant, byte[] bArr, int i, int i2) throws IOException, JsonGenerationException {
        ...
        while (i <= i3) {
            ...
            if (maxLineLength <= 0) {
                ...
                bArr3[i8] = Ev3Constants.Opcode.JR_EQ32;
    ...
    public int _writeBinary(Base64Variant base64Variant, InputStream inputStream, byte[] bArr, int i) throws IOException, JsonGenerationException {
        ...
        while (i7 > 2) {
            ...
            if (i10 <= 0) {
                ...
                bArr3[i12] = Ev3Constants.Opcode.JR_EQ32;
