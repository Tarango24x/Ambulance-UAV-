        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Twitter.this.form.dispatchErrorOccurredEvent(Twitter.this, "Authorize", 303, e.getMessage());
                ...
                AsynchUtil.runAsynchronously(new Runnable() {
                    public void run() {
                        try {
                            ...
                            e.printStackTrace();
                            Twitter.this.form.dispatchErrorOccurredEvent(Twitter.this, "Authorize", 304, e.getMessage());
                            Twitter.this.deAuthorize();
                        }
                    }
                });
        ...
        AsynchUtil.runAsynchronously(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Twitter.this.form.dispatchErrorOccurredEvent(Twitter.this, "RequestMentions", 307, e.getMessage());
                } finally {
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            Twitter.this.mentions.clear();
                            for (Status status : C04976.this.replies) {
                                Twitter.this.mentions.add(status.getUser().getScreenName() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + status.getText());
                            }
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (User user : C04997.this.friends) {
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (DirectMessage message : C05018.this.messages) {
                                Twitter.this.directMessages.add(message.getSenderScreenName() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + message.getText());
                            }
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (Status message : C048712.this.messages) {
                ...
                try {
                    ...
                    Twitter.this.handler.post(new Runnable() {
                        public void run() {
                            ...
                            for (Status tweet : C048913.this.tweets) {
                                Twitter.this.searchResults.add(tweet.getUser().getName() + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + tweet.getText());
                            }
