...
public abstract class Sprite extends VisibleComponent implements AlarmHandler, OnDestroyListener, Deleteable {
    ...
    @SimpleProperty
    /* renamed from: Y */
    public void mo7349Y(double y) {
        updateY(y);
        registerChange();
    }

    /* renamed from: Y */
    public double mo5806Y() {
    ...
    @SimpleProperty
    /* renamed from: Z */
    public void mo7351Z(double layer) {
        this.zLayer = layer;
    ...
    private final boolean overEastEdge(int canvasWidth) {
        if (this.xLeft + ((double) Width()) > ((double) canvasWidth)) {
            return true;
        }
        return DEFAULT_ORIGIN_AT_CENTER;
    }
    ...
    private final boolean overSouthEdge(int canvasHeight) {
        if (this.yTop + ((double) Height()) > ((double) canvasHeight)) {
            return true;
        }
        return DEFAULT_ORIGIN_AT_CENTER;
    }
    ...
    public boolean containsPoint(double qx, double qy) {
        if (qx < this.xLeft || qx >= this.xLeft + ((double) Width()) || qy < this.yTop || qy >= this.yTop + ((double) Height())) {
            return DEFAULT_ORIGIN_AT_CENTER;
        }
        return true;
    }
