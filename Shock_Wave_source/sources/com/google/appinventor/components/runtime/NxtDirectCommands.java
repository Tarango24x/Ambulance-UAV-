...
public class NxtDirectCommands extends LegoMindstormsNxtBase {
    ...
    public void SetOutputState(String motorPortLetter, int power, int mode, int regulationMode, int turnRatio, int runState, long tachoLimit) {
        if (checkBluetooth("SetOutputState")) {
            try {
                ...
                this.form.dispatchErrorOccurredEvent(this, "SetOutputState", 407, motorPortLetter);
            }
        }
    }
    ...
    public void SetInputMode(String sensorPortLetter, int sensorType, int sensorMode) {
        if (checkBluetooth("SetInputMode")) {
            try {
                ...
                this.form.dispatchErrorOccurredEvent(this, "SetInputMode", 408, sensorPortLetter);
            }
        }
    }
    ...
    public List<Number> GetOutputState(String motorPortLetter) {
        ...
        try {
            ...
            this.form.dispatchErrorOccurredEvent(this, "GetOutputState", 407, motorPortLetter);
            return new ArrayList();
        }
    }
    ...
    public List<Object> GetInputValues(String sensorPortLetter) {
        ...
        try {
            ...
            this.form.dispatchErrorOccurredEvent(this, "GetInputValues", 408, sensorPortLetter);
            return new ArrayList();
        }
    }
    ...
    public void ResetInputScaledValue(String sensorPortLetter) {
        if (checkBluetooth("ResetInputScaledValue")) {
            try {
                ...
                this.form.dispatchErrorOccurredEvent(this, "ResetInputScaledValue", 408, sensorPortLetter);
            }
        }
    }
    ...
    public void MessageWrite(int mailbox, String message) {
        if (checkBluetooth("MessageWrite")) {
            if (mailbox < 1 || mailbox > 10) {
                this.form.dispatchErrorOccurredEvent(this, "MessageWrite", 409, Integer.valueOf(mailbox));
                return;
            }
    ...
    public void ResetMotorPosition(String motorPortLetter, boolean relative) {
        if (checkBluetooth("ResetMotorPosition")) {
            try {
                ...
                this.form.dispatchErrorOccurredEvent(this, "ResetMotorPosition", 407, motorPortLetter);
            }
        }
    }
    ...
    public int LsGetStatus(String sensorPortLetter) {
        ...
        try {
            ...
            this.form.dispatchErrorOccurredEvent(this, "LsGetStatus", 408, sensorPortLetter);
            return 0;
        }
    }
                ...
                while (i < array.length) {
                    try {
                        ...
                        if (n2 == 0 || n2 == -1) {
                            ...
                            this.form.dispatchErrorOccurredEvent(this, "LsWrite", 413, Integer.valueOf(i + 1));
                            return;
                        }
                    } catch (NumberFormatException e) {
                        this.form.dispatchErrorOccurredEvent(this, "LsWrite", 412, Integer.valueOf(i + 1));
                        return;
                    }
                }
                lsWrite("LsWrite", port, bytes, rxDataLength);
            } catch (IllegalArgumentException e2) {
                this.form.dispatchErrorOccurredEvent(this, "LsWrite", 408, sensorPortLetter);
            }
        }
    }
    ...
    public List<Integer> LsRead(String sensorPortLetter) {
        ...
        try {
            ...
            this.form.dispatchErrorOccurredEvent(this, "LsRead", 408, sensorPortLetter);
            return new ArrayList();
        }
    }
    ...
    public String MessageRead(int mailbox) {
        ...
        if (mailbox < 1 || mailbox > 10) {
            this.form.dispatchErrorOccurredEvent(this, "MessageRead", 409, Integer.valueOf(mailbox));
            return "";
        }
