...
public class NanoHTTPD {
    ...
    public class Response {
        ...
        public Response(String status2, String mimeType2, String txt) {
            ...
            this.mimeType = mimeType2;
            try {
                this.data = new ByteArrayInputStream(txt.getBytes(HTTP.UTF_8));
    ...
    private class HTTPSession implements Runnable {
        ...
        private void sendError(String status, String msg) throws InterruptedException {
            sendResponse(status, "text/plain", (Properties) null, new ByteArrayInputStream(msg.getBytes()));
    ...
    private String encodeUri(String uri) {
        ...
        while (st.hasMoreTokens()) {
            ...
            if (tok.equals("/")) {
                newUri = newUri + "/";
            } else if (tok.equals(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR)) {
                newUri = newUri + "%20";
            } else {
