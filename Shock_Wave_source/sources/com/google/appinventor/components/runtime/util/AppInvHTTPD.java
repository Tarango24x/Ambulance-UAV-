...
public class AppInvHTTPD extends NanoHTTPD {
        ...
        if (method.equals(HttpOptions.METHOD_NAME)) {
            ...
            if (method.equals(HttpPut.METHOD_NAME)) {
                ...
                if (error.booleanValue()) {
                    NanoHTTPD.Response response4 = new NanoHTTPD.Response(NanoHTTPD.HTTP_INTERNALERROR, "text/plain", "NOTOK");
                ...
                NanoHTTPD.Response response5 = new NanoHTTPD.Response(NanoHTTPD.HTTP_OK, "text/plain", "OK");
    ...
    private NanoHTTPD.Response message(String txt) {
        return addHeaders(new NanoHTTPD.Response(NanoHTTPD.HTTP_OK, "text/plain", txt));
    }
