...
public final class MultiDex {
        ...
        if (versionString != null) {
            ...
            if (matcher.matches()) {
                try {
                    ...
                    isMultidexCapable = (major > 2 || (major == 2 && Integer.parseInt(matcher.group(2)) >= 1)) ? true : IS_VM_MULTIDEX_CAPABLE;
    ...
    private static final class C0535V4 {
        private C0535V4() {
        }
