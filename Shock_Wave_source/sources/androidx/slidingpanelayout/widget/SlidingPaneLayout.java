...
public class SlidingPaneLayout extends ViewGroup {
    ...
    public void setParallaxDistance(@C0001Px int parallaxBy) {
                        ...
                        if (!canSlide || child2 == this.mSlideableView) {
                            if (lp2.weight > 0.0f) {
                                ...
                                if (canSlide) {
                                    ...
                                    child2.measure(View.MeasureSpec.makeMeasureSpec(measuredWidth + ((int) ((lp2.weight * ((float) Math.max(0, widthRemaining))) / weightSum)), Declaration.MODULE_REFERENCE), childHeightSpec);
                                }
                            }
