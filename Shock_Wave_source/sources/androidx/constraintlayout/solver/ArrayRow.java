...
public class ArrayRow implements LinearSystem.Row {
    ...
    boolean isSimpleDefinition = DEBUG;
    boolean used = DEBUG;
            ...
            if (v != null) {
                ...
                if (amount != 0.0f) {
                    ...
                    if (amount == 1.0f) {
                        ...
                        s2 = s2 + amount + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + name;
                    }
                    addedVariable = true;
                }
            }
