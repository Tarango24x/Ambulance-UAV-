...
public class ConstraintWidget {
    ...
    /* renamed from: mX */
    protected int f250mX;

    /* renamed from: mY */
    protected int f251mY;
    ...
    public void reset() {
        ...
        this.mOptimizerMeasurable = AUTOTAG_CENTER;
        this.mOptimizerMeasured = AUTOTAG_CENTER;
        this.mGroupsToSolver = AUTOTAG_CENTER;
    }
    ...
    public String toString() {
        return (this.mType != null ? "type: " + this.mType + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR : "") + (this.mDebugName != null ? "id: " + this.mDebugName + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR : "") + "(" + this.f250mX + ", " + this.f251mY + ") - (" + this.mWidth + " x " + this.mHeight + ") wrap: (" + this.mWrapWidth + " x " + this.mWrapHeight + ")";
    }
    ...
    public int getRootX() {
        return this.f250mX + this.mOffsetX;
    }

    /* access modifiers changed from: protected */
    public int getRootY() {
        return this.f251mY + this.mOffsetY;
    }
    ...
    public void updateDrawPosition() {
        int left = this.f250mX;
        int top = this.f251mY;
        int right = this.f250mX + this.mWidth;
        int bottom = this.f251mY + this.mHeight;
        this.mDrawX = left;
        this.mDrawY = top;
    ...
    public void setDrawOrigin(int x, int y) {
        ...
        this.f250mX = this.mDrawX;
        this.f251mY = this.mDrawY;
    }
    ...
    private boolean isChainHead(int orientation) {
        ...
        if (this.mListAnchors[offset].mTarget == null || this.mListAnchors[offset].mTarget.mTarget == this.mListAnchors[offset] || this.mListAnchors[offset + 1].mTarget == null || this.mListAnchors[offset + 1].mTarget.mTarget != this.mListAnchors[offset + 1]) {
            return AUTOTAG_CENTER;
        }
        return true;
    }
    ...
    public void addToSolver(LinearSystem system) {
        ...
        boolean horizontalParentWrapContent = AUTOTAG_CENTER;
        boolean verticalParentWrapContent = AUTOTAG_CENTER;
        if (this.mParent != null) {
            horizontalParentWrapContent = this.mParent != null ? this.mParent.mListDimensionBehaviors[0] == DimensionBehaviour.WRAP_CONTENT ? true : AUTOTAG_CENTER : AUTOTAG_CENTER;
            verticalParentWrapContent = this.mParent != null ? this.mParent.mListDimensionBehaviors[1] == DimensionBehaviour.WRAP_CONTENT ? true : AUTOTAG_CENTER : AUTOTAG_CENTER;
            if (isChainHead(0)) {
        ...
        boolean horizontalDimensionFixed = this.mListDimensionBehaviors[0] != DimensionBehaviour.MATCH_CONSTRAINT ? true : AUTOTAG_CENTER;
        boolean verticalDimensionFixed = this.mListDimensionBehaviors[1] != DimensionBehaviour.MATCH_CONSTRAINT ? true : AUTOTAG_CENTER;
        ...
        boolean useHorizontalRatio = (!useRatio || !(this.mResolvedDimensionRatioSide == 0 || this.mResolvedDimensionRatioSide == -1)) ? AUTOTAG_CENTER : true;
        boolean wrapContent = (this.mListDimensionBehaviors[0] != DimensionBehaviour.WRAP_CONTENT || !(this instanceof ConstraintWidgetContainer)) ? AUTOTAG_CENTER : true;
        boolean applyPosition = true;
        if (this.mCenter.isConnected()) {
            applyPosition = AUTOTAG_CENTER;
        }
        if (this.mHorizontalResolution != 2) {
            applyConstraints(system, horizontalParentWrapContent, this.mParent != null ? system.createObjectVariable(this.mParent.mLeft) : null, this.mParent != null ? system.createObjectVariable(this.mParent.mRight) : null, this.mListDimensionBehaviors[0], wrapContent, this.mLeft, this.mRight, this.f250mX, width, this.mMinWidth, this.mMaxDimension[0], this.mHorizontalBiasPercent, useHorizontalRatio, inHorizontalChain, matchConstraintDefaultWidth, this.mMatchConstraintMinWidth, this.mMatchConstraintMaxWidth, this.mMatchConstraintPercentWidth, applyPosition);
        }
        if (this.mVerticalResolution != 2) {
            boolean wrapContent2 = (this.mListDimensionBehaviors[1] != DimensionBehaviour.WRAP_CONTENT || !(this instanceof ConstraintWidgetContainer)) ? AUTOTAG_CENTER : true;
            boolean useVerticalRatio = (!useRatio || !(this.mResolvedDimensionRatioSide == 1 || this.mResolvedDimensionRatioSide == -1)) ? AUTOTAG_CENTER : true;
            if (this.mBaselineDistance > 0) {
    ...
    private void applyConstraints(LinearSystem system, boolean parentWrapContent, SolverVariable parentMin, SolverVariable parentMax, DimensionBehaviour dimensionBehaviour, boolean wrapContent, ConstraintAnchor beginAnchor, ConstraintAnchor endAnchor, int beginPosition, int dimension, int minDimension, int maxDimension, float bias, boolean useRatio, boolean inChain, int matchConstraintDefault, int matchMinDimension, int matchMaxDimension, float matchPercentDimension, boolean applyPosition) {
        ...
        boolean variableSize = AUTOTAG_CENTER;
            ...
            if (isBeginConnected || isEndConnected || isCenterConnected) {
                if (!isBeginConnected || isEndConnected) {
                    if (!isBeginConnected && isEndConnected) {
                        ...
                        boolean applyBoundsCheck = AUTOTAG_CENTER;
                        boolean applyCentering = AUTOTAG_CENTER;
