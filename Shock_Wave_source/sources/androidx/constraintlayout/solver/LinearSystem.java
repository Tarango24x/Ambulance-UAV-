...
public class LinearSystem {
    ...
    public SolverVariable createObjectVariable(Object anchor) {
        ...
        if (variable.f248id != -1 && variable.f248id <= this.mVariablesID && this.mCache.mIndexedVariables[variable.f248id] != null) {
            return variable;
        }
        if (variable.f248id != -1) {
            variable.reset();
        }
        this.mVariablesID++;
        this.mNumColumns++;
        variable.f248id = this.mVariablesID;
    ...
    private final int optimize(androidx.constraintlayout.solver.LinearSystem.Row r21, boolean r22) {
        /*
            r20 = this;
            androidx.constraintlayout.solver.Metrics r14 = sMetrics
            if (r14 == 0) goto L_0x0012
            androidx.constraintlayout.solver.Metrics r14 = sMetrics
            long r0 = r14.optimize
            r16 = r0
            r18 = 1
            long r16 = r16 + r18
            r0 = r16
        ...
        L_0x0025:
            ...
            r0 = r20
            androidx.constraintlayout.solver.ArrayRow[] r14 = r0.mRows
            r8 = r14[r9]
            androidx.constraintlayout.solver.SolverVariable r14 = r8.variable
            r15 = -1
            r14.definitionId = r15
            androidx.constraintlayout.solver.Metrics r14 = sMetrics
        ...
        L_0x0045:
            ...
            r14.definitionId = r9
            androidx.constraintlayout.solver.SolverVariable r14 = r8.variable
            r14.updateReferencesWithNewDefinition(r8)
        L_0x0051:
            if (r4 != 0) goto L_0x00ee
            androidx.constraintlayout.solver.Metrics r14 = sMetrics
            if (r14 == 0) goto L_0x0065
            androidx.constraintlayout.solver.Metrics r14 = sMetrics
            long r0 = r14.iterations
            r16 = r0
            r18 = 1
            long r16 = r16 + r18
            r0 = r16
        ...
        L_0x0070:
            return r11
        L_0x0071:
            androidx.constraintlayout.solver.SolverVariable r14 = r21.getKey()
            if (r14 == 0) goto L_0x0085
            r0 = r20
            boolean[] r14 = r0.mAlreadyTestedCandidates
            androidx.constraintlayout.solver.SolverVariable r15 = r21.getKey()
            int r15 = r15.f248id
            r16 = 1
            r14[r15] = r16
        L_0x0085:
            ...
            r0 = r21
            r1 = r20
            androidx.constraintlayout.solver.SolverVariable r7 = r0.getPivotCandidate(r1, r14)
        ...
        L_0x00b0:
            ...
            androidx.constraintlayout.solver.ArrayRow[] r14 = r0.mRows
            r3 = r14[r5]
            androidx.constraintlayout.solver.SolverVariable r13 = r3.variable
            androidx.constraintlayout.solver.SolverVariable$Type r14 = r13.mType
            androidx.constraintlayout.solver.SolverVariable$Type r15 = androidx.constraintlayout.solver.SolverVariable.Type.UNRESTRICTED
            if (r14 != r15) goto L_0x00c7
        L_0x00c4:
            int r5 = r5 + 1
            goto L_0x00b0
        L_0x00c7:
            boolean r14 = r3.isSimpleDefinition
            if (r14 != 0) goto L_0x00c4
            boolean r14 = r3.hasVariable(r7)
            if (r14 == 0) goto L_0x00c4
            androidx.constraintlayout.solver.ArrayLinkedVariables r14 = r3.variables
            float r2 = r14.get(r7)
            r14 = 0
            int r14 = (r2 > r14 ? 1 : (r2 == r14 ? 0 : -1))
            if (r14 >= 0) goto L_0x00c4
            float r14 = r3.constantValue
            float r14 = -r14
            float r12 = r14 / r2
