...
public class FontResourcesParserCompat {
    ...
    public static androidx.core.content.res.FontResourcesParserCompat.FamilyResourceEntry parse(org.xmlpull.v1.XmlPullParser r3, android.content.res.Resources r4) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L_0x000a:
            ...
            throw r1
        L_0x0014:
            androidx.core.content.res.FontResourcesParserCompat$FamilyResourceEntry r1 = readFamilies(r3, r4)
            return r1
        */
    ...
    private static FamilyResourceEntry readFamily(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        TypedArray array = resources.obtainAttributes(Xml.asAttributeSet(parser), C0105R.styleable.FontFamily);
        String authority = array.getString(C0105R.styleable.FontFamily_fontProviderAuthority);
        String providerPackage = array.getString(C0105R.styleable.FontFamily_fontProviderPackage);
        String query = array.getString(C0105R.styleable.FontFamily_fontProviderQuery);
        int certsId = array.getResourceId(C0105R.styleable.FontFamily_fontProviderCerts, 0);
        int strategy = array.getInteger(C0105R.styleable.FontFamily_fontProviderFetchStrategy, 1);
        int timeoutMs = array.getInteger(C0105R.styleable.FontFamily_fontProviderFetchTimeout, 500);
        array.recycle();
    ...
    private static FontFileResourceEntry readFont(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        TypedArray array = resources.obtainAttributes(Xml.asAttributeSet(parser), C0105R.styleable.FontFamilyFont);
        int weight = array.getInt(array.hasValue(C0105R.styleable.FontFamilyFont_fontWeight) ? C0105R.styleable.FontFamilyFont_fontWeight : C0105R.styleable.FontFamilyFont_android_fontWeight, 400);
        boolean isItalic = 1 == array.getInt(array.hasValue(C0105R.styleable.FontFamilyFont_fontStyle) ? C0105R.styleable.FontFamilyFont_fontStyle : C0105R.styleable.FontFamilyFont_android_fontStyle, 0);
        int ttcIndexAttr = array.hasValue(C0105R.styleable.FontFamilyFont_ttcIndex) ? C0105R.styleable.FontFamilyFont_ttcIndex : C0105R.styleable.FontFamilyFont_android_ttcIndex;
        String variationSettings = array.getString(array.hasValue(C0105R.styleable.FontFamilyFont_fontVariationSettings) ? C0105R.styleable.FontFamilyFont_fontVariationSettings : C0105R.styleable.FontFamilyFont_android_fontVariationSettings);
        int ttcIndex = array.getInt(ttcIndexAttr, 0);
        int resourceAttr = array.hasValue(C0105R.styleable.FontFamilyFont_font) ? C0105R.styleable.FontFamilyFont_font : C0105R.styleable.FontFamilyFont_android_font;
