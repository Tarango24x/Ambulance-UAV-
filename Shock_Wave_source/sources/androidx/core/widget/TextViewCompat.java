...
import androidx.annotation.C0001Px;
...
public final class TextViewCompat {
    ...
    public static void setFirstBaselineToTopHeight(@NonNull TextView textView, @C0001Px @IntRange(from = 0) int firstBaselineToTopHeight) {
        int fontMetricsTop;
    ...
    public static void setLastBaselineToBottomHeight(@NonNull TextView textView, @C0001Px @IntRange(from = 0) int lastBaselineToBottomHeight) {
    ...
    public static void setLineHeight(@NonNull TextView textView, @C0001Px @IntRange(from = 0) int lineHeight) {
