...
public class FontsContractCompat {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:40:0x0094, code lost:
        sBackgroundThread.postAndReply(r2, new androidx.core.provider.FontsContractCompat.C01193());
     */
    ...
    public static android.graphics.Typeface getFontSync(final android.content.Context r9, final androidx.core.provider.FontRequest r10, @androidx.annotation.Nullable final androidx.core.content.res.ResourcesCompat.FontCallback r11, @androidx.annotation.Nullable final android.os.Handler r12, boolean r13, int r14, final int r15) {
        /*
            ...
            androidx.collection.LruCache<java.lang.String, android.graphics.Typeface> r7 = sTypefaceCache
        ...
        L_0x002b:
            ...
            androidx.core.provider.FontsContractCompat$TypefaceResult r6 = getFontInternal(r9, r10, r15)
        ...
        L_0x0048:
            ...
            androidx.core.provider.SelfDestructiveThread r7 = sBackgroundThread     // Catch:{ InterruptedException -> 0x005a }
            java.lang.Object r7 = r7.postAndWait(r2, r14)     // Catch:{ InterruptedException -> 0x005a }
            androidx.core.provider.FontsContractCompat$TypefaceResult r7 = (androidx.core.provider.FontsContractCompat.TypefaceResult) r7     // Catch:{ InterruptedException -> 0x005a }
        ...
        L_0x0060:
            ...
            monitor-enter(r8)
            androidx.collection.SimpleArrayMap<java.lang.String, java.util.ArrayList<androidx.core.provider.SelfDestructiveThread$ReplyCallback<androidx.core.provider.FontsContractCompat$TypefaceResult>>> r7 = sPendingReplies     // Catch:{ all -> 0x007b }
        ...
        L_0x007b:
            ...
            throw r7
        L_0x007e:
            androidx.core.provider.FontsContractCompat$2 r5 = new androidx.core.provider.FontsContractCompat$2
            r5.<init>(r11, r12)
            goto L_0x0060
        L_0x0084:
        ...
        L_0x0093:
            monitor-exit(r8)     // Catch:{ all -> 0x007b }
            androidx.core.provider.SelfDestructiveThread r7 = sBackgroundThread
            androidx.core.provider.FontsContractCompat$3 r8 = new androidx.core.provider.FontsContractCompat$3
            r8.<init>(r3)
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int ttcIndex, @IntRange(from = 1, mo30to = 1000) int weight, boolean italic, int resultCode) {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                try {
                    ...
                    while (cursor.moveToNext()) {
                        ...
                        result2.add(new FontInfo(fileUri, ttcIndex, weightColumnIndex != -1 ? cursor.getInt(weightColumnIndex) : HttpStatus.SC_BAD_REQUEST, italicColumnIndex != -1 && cursor.getInt(italicColumnIndex) == 1, resultCode));
                    }
                    result = result2;
                } catch (Throwable th) {
                    th = th;
