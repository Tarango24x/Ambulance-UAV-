...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public boolean onStateChange(int[] stateSet) {
        ...
        boolean changed = DBG_VECTOR_DRAWABLE;
        VectorDrawableCompatState state = this.mVectorState;
    ...
    public static androidx.vectordrawable.graphics.drawable.VectorDrawableCompat create(@androidx.annotation.NonNull android.content.res.Resources r8, @androidx.annotation.DrawableRes int r9, @androidx.annotation.Nullable android.content.res.Resources.Theme r10) {
        /*
            r7 = 2
            ...
            r1.<init>()
            android.graphics.drawable.Drawable r5 = androidx.core.content.res.ResourcesCompat.getDrawable(r8, r9, r10)
            r1.mDelegateDrawable = r5
            androidx.vectordrawable.graphics.drawable.VectorDrawableCompat$VectorDrawableDelegateState r5 = new androidx.vectordrawable.graphics.drawable.VectorDrawableCompat$VectorDrawableDelegateState
        ...
        L_0x0043:
            ...
            goto L_0x001f
        L_0x0045:
            androidx.vectordrawable.graphics.drawable.VectorDrawableCompat r1 = createFromXmlInner(r8, r3, r0, r10)     // Catch:{ XmlPullParserException -> 0x003b, IOException -> 0x004a }
            goto L_0x001f
        L_0x004a:
            r2 = move-exception
            java.lang.String r5 = "VectorDrawableCompat"
    ...
    private static class VGroup extends VObject {
        ...
        public boolean onStateChanged(int[] stateSet) {
            boolean changed = VectorDrawableCompat.DBG_VECTOR_DRAWABLE;
            for (int i = 0; i < this.mChildren.size(); i++) {
